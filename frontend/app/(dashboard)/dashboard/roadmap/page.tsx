...
import { Map, Clock, Users, Zap, CheckCircle, Circle, IndianRupee, Calendar, Layers } from 'lucide-react';
...
const ROADMAP_TOOLTIP = {
  title: 'Implementation Roadmap Engine',
  techStack: ['TypeScript 5', 'Quart Blueprint', 'Framer Motion', 'TailwindCSS v3'],
  implementation: 'Prioritizes automation initiatives into a 24-week GANTT-style schedule based on effort-to-impact matrix calculations.',
  howItWorks: 'Divides adoption into Phase 1 Quick Wins (W1-W4), Phase 2 Core Systems (W5-W12), and Phase 3 Advanced AI Agents (W13-W24) to minimize operational disruption.',
};
...
function RoadmapItemCard({ item, phaseColor }: { item: RoadmapItem; phaseColor: string }) {
  ...
  return (
    <div className="p-6 rounded-2xl border border-white/10 bg-[#0e1122] hover:bg-white/[0.04] hover:border-white/20 transition-all space-y-4 shadow-lg">
      <div className="flex items-start justify-between gap-4">
        <div className="space-y-1">
          ...
          <p className="text-xs text-slate-400 leading-relaxed pl-5">{item.description}</p>
        </div>
  ...
  return (
    <div className="space-y-8 max-w-7xl mx-auto pb-12">
      ...
      >
        <div className="space-y-1">
          <div className="flex items-center gap-3">
            ...
            <FeatureInfoTooltip info={ROADMAP_TOOLTIP} />
          </div>
      ...
      <div className="space-y-2">
        <div className="flex justify-between text-xs font-semibold text-slate-400 uppercase tracking-wider px-1">
          ...
          >
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-xs text-slate-400">Duration: {phase.duration_weeks} weeks · {phase.items.length} initiatives</p>
              </div>
            </div>
